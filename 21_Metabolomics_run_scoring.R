...
results <- list()
traits_list <- list()
location <- '/path_to_files.../tables_cut/'
...
olink <- readRDS('/path_to_files.../knn_imputed_processed_olink_internal_proteins.rds')

# Read in metabolite imputed data
metab <- read.csv('/path_to_files.../knn_imputed_processed_metab_data.csv')
...
chosen <- read.csv("/path_to_files.../Run_210723_processing/models_chosen_accounted_features.csv")

# Load diabetes info

### Define diseases from chosen models
location_out <- "/path_to_files.../ProteinScores/Run_210723/"
core_models_output <- '/path_to_files.../ProteinScores/Run_210723_processing/covariate_assessment/'
...
y_train <- readRDS("/path_to_files.../Run_210723/Diab_FO/files/y_train_18.rds")
y_test <- readRDS("/path_to_files.../Run_210723/Diab_FO/files/y_test_18.rds")

x_train <- readRDS("/path_to_files.../Run_210723/Diab_FO/files/x_train_18.rds")
x_test <- readRDS("/path_to_files.../Run_210723/Diab_FO/files/x_test_18.rds")
...
location_out1 <- '/path_to_files.../prot/'
saveRDS(x_train, paste0(location_out1, name, '/files/x_train_', '18', '.rds'))
saveRDS(x_test, paste0(location_out1, name, '/files/x_test_', '18', '.rds'))
saveRDS(y_train, paste0(location_out1, name, '/files/y_train_', '18', '.rds'))
saveRDS(y_test, paste0(location_out1, name, '/files/y_test_', '18', '.rds'))
...
# Save train and test files with iteration identifiers
location_out1 <- '/path_to_files.../metab/'
saveRDS(x_train, paste0(location_out1, name, '/files/x_train_', '18', '.rds'))
saveRDS(x_test, paste0(location_out1, name, '/files/x_test_', '18', '.rds'))
saveRDS(y_train, paste0(location_out1, name, '/files/y_train_', '18', '.rds'))
saveRDS(y_test, paste0(location_out1, name, '/files/y_test_', '18', '.rds'))
...
# Save train and test files with iteration identifiers
location_out1 <- '/path_to_files.../metab_scores_analyses/joint/'
saveRDS(x_train, paste0(location_out1, name, '/files/x_train_', '18', '.rds'))
saveRDS(x_test, paste0(location_out1, name, '/files/x_test_', '18', '.rds'))
saveRDS(y_train, paste0(location_out1, name, '/files/y_train_', '18', '.rds'))
saveRDS(y_test, paste0(location_out1, name, '/files/y_test_', '18', '.rds'))

# Set cv to 3 as all cases < 500
...
location_out1 <- '/path_to_files.../metab_scores_analyses/prot/'
x_train <- readRDS(paste0(location_out1, name, '/files/x_train_', '18', '.rds'))
y_train <- readRDS(paste0(location_out1, name, '/files/y_train_', '18', '.rds'))
...
location_out1 <- '/path_to_files.../metab_scores_analyses/metab/'
x_train <- readRDS(paste0(location_out1, name, '/files/x_train_', '18', '.rds'))
y_train <- readRDS(paste0(location_out1, name, '/files/y_train_', '18', '.rds'))
