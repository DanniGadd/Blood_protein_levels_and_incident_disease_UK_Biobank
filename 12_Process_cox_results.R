...
table <- read.csv("Associations_retained_Bon.csv")
...
table$Protein <- factor(table$Protein, levels = c("GDF15", "IL6_1", "IL6_2", "PLAUR", 'NEFL', 'ASGR1', 'CHI3L1', 'IL6_3', 'IL6_4',
                                                  "TNFRSF1A",  'TNFRSF1B','CSF1', "LGALS9", "CD74", "HAVCR2","CD300E" , "TNFRSF4",
                                                  ...
                                                  "PGF" ,      "IL2RA" ,    "IL18BP",    "LAIR1"  ,   "LAMP3" ,    "CST3",
                                                      "CXCL9" ,    "TNFRSF9" ,"CCL3" ,   "CXCL13" ,   "LILRB4"  ,  "MDK",
                                                     "MZB1" , "TNFSF13",    "TNFRSF14",  "ZBTB17" ,     "ITGAV", "ITGA11" 
                                                  ))
# 
...
pdf("plot_multimorbidity_associations_updated_heatmap_Bon_legend.pdf", width = 18, height =7)
